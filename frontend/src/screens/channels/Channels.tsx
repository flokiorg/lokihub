...
import { NodeHealthInfoDialog } from "src/components/channels/NodeHealthInfoDialog";
...
function getNodeHealth(channels: Channel[]) {
  ...
  const nodeHealth = Math.ceil(
    numUniqueChannelPartners *
      ...
      (Math.min(totalChannelCapacitySats, 1_000_000) / 1_000_000) * // 1 million loki or more is great
