...
export function MigrateNode() {
  ...
  return (
    <>
      <SettingsHeader
        title="Migrate Lokihub"
        description="Create migration file in order to move your Lokihub to another device or server."
      />
      ...
      {showPasswordScreen ? (
        ...
        <div className="flex gap-4">
          ...
          >
            Create Lokihub Migration File
          </Button>

          <LinkButton to="/settings/backup" variant={"secondary"}>
            Backup Without Migrating Lokihub
          </LinkButton>
        </div>
      )}
    </>
