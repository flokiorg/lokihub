...
export function CreateNodeMigrationFileSuccess() {
  return (
    <>
      <div className="p-10">
        <AppHeader
          title="Lokihub Migration File Saved"
          ...
          <CardContent className="pt-6">
            <div className="flex justify-center flex-col gap-4 text-foreground">
              <div className="flex gap-2 items-center ">
                ...
                <span>
                  Your Lokihub migration file has been successfully saved to
                  your filesystem.
                </span>
              </div>
              <div className="flex gap-2 items-center">
                ...
                <span>
                  This Lokihub has is now in a halted state to prevent further
                  changes.{" "}
                  <b>
              ...
              <div className="flex gap-2 items-center">
                ...
                <span>
                  Start your new Lokihub on another machine and choose the
