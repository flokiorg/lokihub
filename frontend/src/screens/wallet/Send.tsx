import { Invoice } from "@lightz/lightning-tools/bolt11";
import { LightningAddress } from "@lightz/lightning-tools/lnurl";
...
const validateFlokicoinAddress = (addr: string) => {
  try {
...
export default function Send() {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setLoading(true);
      if (validateFlokicoinAddress(recipient)) {
