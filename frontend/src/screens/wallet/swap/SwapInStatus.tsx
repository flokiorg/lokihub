...
export default function SwapInStatus() {
  ...
  const [, setPaidWithLokihub] = React.useState(false);
  ...
  const payWithLokihub = React.useCallback(() => {
    (async () => {
      setPaying(true);
      try {
        if (!swap) {
  ...
  }, [feeRate, isInternalSwap, payWithLokihub, swap]);
      ...
      <div className="w-full max-w-lg">
        <Card className="w-full md:max-w-xs">
          ...
          <CardContent className="flex flex-col items-center gap-4">
              ...
              <>
                ...
                {!swap.lockupTxId && !isInternalSwap && (
                  <div className="flex justify-center gap-4 flex-wrap">
                    ...
                    {swap.state === "PENDING" && (
                      <ExternalLinkButton
                        to={`flokicoin:${swap.lockupAddress}?amount=${swap.sendAmount / 100_000_000}`}
                        variant="secondary"
                      >
            ...
            {/* We only show status screen once flokicoin is locked up */}
            {swap.lockupTxId ? (
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            ...
                            {swapStatus !== "REFUNDED" &&
                              " You can use the Swap Refund button in Settings -> Debug Tools to claim the locked up flokicoin."}
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </div>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        ...
                        {"->"} Debug Tools to claim the locked up flokicoin.
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
