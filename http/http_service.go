...
func (httpSvc *HttpService) RegisterSharedRoutes(e *echo.Echo) {
	...
	e.Use(middleware.SecureWithConfig(middleware.SecureConfig{
		...
		XFrameOptions:         "DENY",
		ContentSecurityPolicy: "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; connect-src 'self' wss:; img-src 'self' data:; frame-src 'none'; object-src 'none'; base-uri 'self';",
